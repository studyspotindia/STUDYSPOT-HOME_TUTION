...
const Subject = () => {
    ...
    return (
        <Box className='mainSubjectDIv' mt={{ base: "50px", sm: "", md: "80px", lg: "100px" }}>

            <Box height="auto" width={{ base: "80%", sm: "80%", md: "80%", lg: "80%" }} m="auto" mt={{ base: "0px", sm: "", md: "40px", lg: "40px" }} >
            ...
            <Text fontFamily="sans-serif" fontSize={{ base: "28px", sm: "28px", md: "31px", lg: "4xl" }} mt={{ base: "80px", sm: "", md: "100px", lg: "140px" }} textAlign="center" fontWeight={"bold"}>Get a Perfect Home Tutor within 30 Minutes</Text>
