...
import { authStudentSignup, authTeacherSignup } from '../../Redux/Auth/Auth.action';
// {
...
const Form1 = ({ formData, setFormData }) => {
  ...
  return (
    <Box mt={{base:"60px",sm:"100px",md:"60px",lg:"60px"}} >
      ...
      <Flex mt="40px">
        <FormControl mr="5%">
          <FormLabel htmlFor="first-name" fontWeight={'600'} as='b'>
            Teacher Name
          </FormLabel>
          <Input 
          id="name" 
        ...
        <FormControl>
          <FormLabel htmlFor="last-name" fontWeight={'600'} as='b'>
          Profile Pic
          </FormLabel>
          <Input 
          id="last-name" 
...
export default function TeacherSignup() {
  ...
  const auth = useSelector((state) => state.auth);
    console.log(auth, " teacher message in signup")
  ...
  useEffect(()=>{
    if(auth.message==="You are registered"){
        ...
        toast({
            title: 'Teacher Email already exists',
            position: 'top',
            status: 'error',
            isClosable: true,
          })
  ...
  const handleSubmit = (event) => {
   ...
   if (formData.email !== "" && formData.password !== "" && formData.name !== "" && formData.profile !== "" && formData.phone !== "" && formData.highereducation !== "" && formData.location !== "" && formData.subjecttaught !== "" && formData.tutiontype !== "" && formData.fees !== "" && formData.classtaught !== "" && formData.about !== "" && formData.experience !== "" ) {
        dispatch(authTeacherSignup(formData));
        console.log("done")
       // setFormData("")
    ...
    <Box mt="150px" h="auto">
      <Box
       ...
       boxShadow= "rgba(0, 0, 0, 0.35) 0px 5px 15px"
        ...
        m="10px auto"
        as="form">
        <Progress hasStripe value={progress} mb="5%" mx="" h="25px" borderRadius={"20px"} colorScheme='teal' isAnimated></Progress>
        ...
        <Box mt="50px">
              ...
              >
                <Link to="/teacherlogin">
                  ...
                  >
                    Existing Teacher? Go to Login Page
                  </Button>
                </Link>
